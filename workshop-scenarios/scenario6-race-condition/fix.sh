#!/bin/bash
# Scenario 6 Fix: Remove the race condition
# Restores the original SearchController without the thread-unsafe analytics
...
echo "╔══════════════════════════════════════════════════════════════════╗"
echo "║  Scenario 6 Fix: Remove Race Condition                           ║"
echo "╚══════════════════════════════════════════════════════════════════╝"
echo ""

# Restore from backup if exists, otherwise restore original
if [ -f "$CONTROLLER.backup" ]; then
    cp "$CONTROLLER.backup" "$CONTROLLER"
    rm "$CONTROLLER.backup"
else
...
echo "✅ Fix applied!"
echo ""
echo "📁 Restored: PetAdoptions/petsearch-java/src/main/java/ca/petsearch/controllers/SearchController.java"
echo "   Removed: Non-thread-safe analytics tracking"
echo ""
...
# =============================================================================
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "📤 Committing and pushing fix to CodeCommit..."
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"

cd "$REPO_ROOT"
git add PetAdoptions/petsearch-java/src/main/java/ca/petsearch/controllers/SearchController.java
git commit -m "fix: remove thread-unsafe analytics causing intermittent failures" 2>/dev/null || echo "   (No changes to commit)"
git push origin main

echo ""
echo "✅ Fix pushed to CodeCommit - pipeline will trigger automatically"
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "💡 Best Practice: For thread-safe shared state:"
echo ""
echo "   • Use ConcurrentHashMap instead of HashMap"
echo "   • Use CopyOnWriteArrayList for read-heavy lists"
echo "   • Use AtomicInteger/AtomicLong for counters"
echo "   • Use synchronized blocks for complex operations"
echo "   • Consider using Micrometer metrics instead of custom tracking"
echo "   • Better yet: use stateless design and external metrics systems"
